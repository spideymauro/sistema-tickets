...
const { sembrarTicketsEjemplo } = require('./utils/seedTickets');
...
// El seed de tickets va después: depende de que el admin (id_usuario=1) ya exista
setTimeout(() => sembrarTicketsEjemplo(db), 1800);
...
app.use('/api/admin/tickets', require('./routes/admin'));
