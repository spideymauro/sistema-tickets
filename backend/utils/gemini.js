...
{"es_solicitud_legitima": <true o false>, "categoria_detectada": "<la categoría de la lista de arriba que mejor corresponde, o la misma que eligió el usuario si es_solicitud_legitima es false>", "sugerencia": "<una sugerencia breve, concreta y confiable en español, máximo 2 oraciones, para que el usuario resuelva esto por su cuenta, o null si no tienes una sugerencia confiable, específica, o si es_solicitud_legitima es false>"}`;
}
...
async function analizarConIA(categoria, mensaje) {
  ...
  try {
    ...
    return { categoriaDetectada, sugerencia, esSolicitudLegitima };
  } catch (err) {
