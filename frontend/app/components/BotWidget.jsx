...
export default function BotWidget() {
  ...
  function continuarConSugerencia(sugerencia) {
    if (sugerencia) {
  ...
  async function consultarSugerenciaIA(cat, mensaje) {
    try {
      ...
      return await resp.json(); // { categoriaDetectada, sugerencia }
    } catch {
      return null;
    }
  }
  ...
  function confirmarCategoria(cambiar) {
    ...
    continuarConSugerencia(sugerenciaAUsar);
  }
  ...
  async function enviarDescripcion(e) {
    ...
    continuarConSugerencia(analisis.sugerencia);
  }
