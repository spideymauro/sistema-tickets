...
import { buscarSugerencia } from '../lib/faq';
...
export default function BotWidget() {
  ...
  function enviarDescripcion(e) {
    ...
    const sugerencia = buscarSugerencia(categoria, texto);
    if (sugerencia) {
      agregarMensaje('bot', `${sugerencia} ¿Esto resolvió tu problema?`);
      setPaso(PASOS.FAQ);
    } else {
      agregarMensaje('bot', 'Entendido, vamos a levantar tu ticket. ¿Cuál es tu correo?');
  ...
  return (
    <div className={styles.widget}>
      <header className={styles.encabezado}>
        ...
        <div>
          <p className={styles.nombreBot}>Soporte Azabache</p>
