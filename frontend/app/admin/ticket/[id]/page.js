...
export default function DetalleTicket() {
  ...
  if (cargando) return <main className={styles.contenedor}><p className={styles.nota}>Cargando…</p></main>;
  if (error) return <main className={styles.contenedor}><p className={styles.error}>{error}</p></main>;
